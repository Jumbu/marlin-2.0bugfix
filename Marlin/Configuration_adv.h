...
#define DISABLE_INACTIVE_X 0  
#define DISABLE_INACTIVE_Y 0
#define DISABLE_INACTIVE_Z 0  // Set to false if the nozzle will fall down on your printed part when print has finished.
#define DISABLE_INACTIVE_E 0
